...
exports.getOrCreateSubfolder = getOrCreateSubfolder;
...
async function getAuthClient() {
    try {
        ...
        if (process.env.GOOGLE_CREDENTIALS_JSON) {
            ...
            const content = fs_1.default.readFileSync('./credentials.json', 'utf8');
        ...
        if (process.env.GOOGLE_TOKEN_JSON) {
            ...
            const token = fs_1.default.readFileSync('./token.json', 'utf8');
